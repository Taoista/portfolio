const posts = [
   ...
   },
   {
    id: 2,
    fecha: '27 de Abril 2025',
    url: 'laravel-el-mejor-framework-para-desarrollo-web',
    title:'Laravel el mejor framework para desarrollo web',
    img:'https://i.ibb.co/C3Sb8QKP/Curso-esencial-de-Inteligencia-Artificial-Miniatura-de-You-Tube.png',
    descripcion:[
        'La inteligencia artificial (IA) ya no es una opción futurista: es una necesidad estratégica. Empresas líderes y expertos coinciden en que aquellas organizaciones que no integren IA en sus procesos quedarán rezagadas o incluso desaparecerán del mercado en los próximos años.​',
    ],
    body:[
        {
            ...
            text:[
                'Laravel es un framework de desarrollo web en PHP que sigue el patrón de arquitectura MVC (Modelo-Vista-Controlador). Fue creado por Taylor Otwell y es conocido por su sintaxis elegante y expresiva, que facilita el desarrollo de aplicaciones web robustas y mantenibles.',
            ],
        },
        {
            title:'¿Por qué usar Laravel?',
            text:[
                '1.	Fácil de aprender y usar: Laravel ofrece una curva de aprendizaje amigable, ideal tanto para principiantes como para desarrolladores con experiencia.',
                '2.	Rápido desarrollo: Laravel ofrece una curva de aprendizaje amigable, ideal tanto para principiantes como para desarrolladores con experiencia.',
                '3.	Seguridad integrada: Incluye protección contra ataques comunes como SQL Injection, XSS y CSRF, sin necesidad de implementaciones manuales.',
                '4.	Sistema de rutas simple y poderoso: Permite definir rutas de manera clara, lo que mejora la organización y mantenimiento del código.',
                '5.	Ecosistema robusto: Laravel cuenta con herramientas como Laravel Forge, Laravel Vapor, y paquetes como Laravel Sanctum, Passport, etc., que amplían su funcionalidad.',
                '6.	Comunidad activa: Una gran comunidad significa acceso a miles de tutoriales, paquetes y soporte constante.'
            ],
        },
        {
            title:'¿Quién usa Laravel?',
            text:[
                'Laravel es un framework de PHP ampliamente utilizado por empresas de diversos sectores para desarrollar aplicaciones web robustas y escalables, te dejo cinco empresas destacadas que emplean Laravel en sus proyectos: PFIZER, BBC, PedidosYa, TESLA y Disney entre otros'
            ]
        }
